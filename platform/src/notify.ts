      ...
      if (r) {
        await send(env, actor, {
          ...
          text: [
            ...
            ``,
            `Your folder is ready on your page: a statement of the transaction from`,
            `us, your own record with proof it has not been altered, and your`,
            `documents. Keep it — it is how you show, later, where these funds came`,
            `from. It is marked provisional until the whole record is sealed, and the`,
            `same link gives you the final version then.`,
            ``,
            `${CLIENT}/d/${txId}`,
          ].join("\n"),
